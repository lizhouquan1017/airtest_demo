...
class CashierTest(StartEnd, TestCase_):
    ...
    def test_01_cashier_case(self):
        """正常收银"""
        num1 = self.get_goods_qty('测试商品8号') - 30
        ...
        cashier.normal_cashier_action(30)
        time.sleep(1)
    ...
    def test_02_goods_discount_sales_case(self):
        ...
        self.login_action()
        cashier = CashierView()
        cashier.goods_modify_discount(1, '打折', 1)
    ...
    def test_03_goods_modify_sales_case(self):
        ...
        self.login_action()
        cashier = CashierView()
        cashier.goods_modify_discount(1, '改价', 20)
        cashier.order_modify_discount('无优惠')
        sales_order_num = cashier.get_sales_order_num()
    ...
    def test_04_discount_discount_sales_case(self):
        ...
        self.login_action()
        cashier = CashierView()
        cashier.goods_modify_discount(1, '打折', 5)
    ...
    def test_05_modify_discount_sales_case(self):
        ...
        self.login_action()
        cashier = CashierView()
        cashier.goods_modify_discount(1, '改价', 100)
